...
ISR(PCINT2_vect){
	...
	if(current_position == 0 && previouse_position == 8 && encoder.encoder_value <= encoder.e_value_max){encoder.encoder_value ++;}
	else if(current_position == 12 && previouse_position == 4 && encoder.encoder_value <= encoder.e_value_max){encoder.encoder_value ++;}
	else if(current_position == 0 && previouse_position == 4 && encoder.encoder_value >= encoder.e_value_min){encoder.encoder_value --;}
	else if(current_position == 12 && previouse_position == 8 && encoder.encoder_value >= encoder.e_value_min){encoder.encoder_value --;}
